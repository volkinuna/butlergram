...
public class UserController {
    ...
    public String profile(HttpServletRequest request, @PathVariable(value = "userId") Long userId,
    ...
    public ResponseEntity<?> profileImageUrlUpdate(@PathVariable("principalId") Long principalId,
